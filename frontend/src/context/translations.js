export const translations = {
  en: {
    ...
    taxFinancialOverviewSubtitle:
      "Key stats from your synced financial summary",
    ...
    expenseTrackerInsightsSubtitle: "Powered by your financial behavior",
    expenseTrackerFetchError: "Failed to load expenses.",
    expenseTrackerLoading: "Loading your expenses...",
    expenseTrackerUnknownCategory: "General",
    expenseTrackerNoDate: "Date unavailable",
    expenseTrackerNoAmount: "N/A",
    expenseTrackerTotalDetail: "Total spent in selected period",
    expenseTrackerAvgDailyDetail: "Average daily spending",
    expenseTrackerSavingsTrend: "Savings Trend",
    expenseTrackerExpenseTrend: "Expense Trend",
    expenseTrackerTrendSubtitle: "Monthly outlook",
    expenseTrackerSavingsPrediction: "Savings Prediction",
    expenseTrackerCategorySplit: "Category Split",
    expenseTrackerCategorySplitSub: "Spending breakdown by category",
    expenseTrackerCategoryComparison: "Category Comparison",
    expenseTrackerCategoryComparisonSub: "Month-over-month by category",
    trackExpensesCta: "Track Your Expenses",
  },
  ...
  hi: {
    ...
    saved: "बचाया",
    clickToEditGoal: "लक्षय संपादित करने के लिए क्लिक करें",
    ...
    taxPageSubtitle:
      "नई कर व्यवस्था के तहत वित्तीय वर्ष के लिए आधिकारिक प्रक्षेपण",
    ...
    taxFinancialOverviewSubtitle:
      "आपके सिंक किए गए वित्तीय सारांश से मुख्य आंकड़े",
    ...
    taxAdvisory: "परामर्श",
    taxAdvisoryText:
      "यह रिपोर्ट आपके CreditFlow प्रोफ़ाइल में सिंक किए गए सत्यापित आय और व्यय डेटा से तैयार की गई है। कृपया फाइलिंग पुष्टि, अतिरिक्त कटौती और अपनी स्थिति के अनुसार घोषणाओं के लिए एक प्रमाणित कर पेशेवर से परामर्श लें।",
    ...
    expenseTrackerInsightsSubtitle: "आपके वित्तीय व्यवहार द्वारा संचालित",
    expenseTrackerFetchError: "खर्च लोड करने में विफल।",
    expenseTrackerLoading: "आपके खर्च लोड हो रहे हैं...",
    expenseTrackerUnknownCategory: "सामान्य",
    expenseTrackerNoDate: "तारीख उपलब्ध नहीं",
    expenseTrackerNoAmount: "अनुपलब्ध",
    expenseTrackerTotalDetail: "चुनी गई अवधि में कुल खर्च",
    expenseTrackerAvgDailyDetail: "औसत दैनिक खर्च",
    expenseTrackerSavingsTrend: "बचत प्रवृत्ति",
    expenseTrackerExpenseTrend: "खर्च प्रवृत्ति",
    expenseTrackerTrendSubtitle: "मासिक दृष्टिकोण",
    expenseTrackerSavingsPrediction: "बचत पूर्वानुमान",
    expenseTrackerCategorySplit: "श्रेणी विभाजन",
    expenseTrackerCategorySplitSub: "श्रेणी के अनुसार खर्च",
    expenseTrackerCategoryComparison: "श्रेणी तुलना",
    expenseTrackerCategoryComparisonSub: "महीने-दर-महीने तुलना",
    trackExpensesCta: "अपने खर्चों को ट्रैक करें",
  },
  ...
  mr: {
    ...
    securePrivateDetail:
      "तुमचा आर्थिक डेटा स्थानिक पातळीवर विश्लेषित केला जातो आणि तिसऱ्या पक्षांशी कधीही शेअर केला जात नाही",
    designedForGig: "गिग वर्कर्ससाठी डिझाइन केलेले",
    designedForGigDetail:
      "पारंपारिक क्रेडिट ब्युरोच्या उलट, आम्ही अनियमित उत्पन्न नमुने समजतो",
    ...
    calculateCreditScoreDetail:
      "तत्काळ क्रेडिट मूल्यांकनासाठी बँक स्टेटमेंट अपलोड करा",
    uploadNow: "आता अपलोड करा",
    improveYourScore: "तुमचा स्कोर सुधारा",
    reduceExpenseRatio: "खर्चाचे प्रमाण कमी करा",
    targetBelow50: "चांगल्या दरांसाठी ५०% पेक्षा कमी लक्ष्य ठेवा",
    trackExpenses: "खर्च ट्रॅक करा",
    trackDailyExpenses: "पर्यायी: दैनिक खर्च ट्रॅक करा",
    trackDailyExpensesDetail:
      "क्रेडिट स्कोरसाठी आवश्यक नाही, परंतु वित्त व्यवस्थापनासाठी खर्च ट्रॅकिंग मदत करते",
    addExpense: "खर्च जोडा",
    doingGreat: "तुम्ही उत्तम करत आहात!",
    ...
    savingsGoal: "बचत लक्ष्य",
    saved: "बचत केली",
    clickToEditGoal: "लक्ष्य संपादित करण्यासाठी क्लिक करा",

    // Category Breakdown
    categoryBreakdown: "श्रेणीनुसार तपशील",

    // Savings Goal Modal
    editSavingsGoal: "बचत लक्ष्य संपादित करा",
    monthlyTarget: "मासिक बचत लक्ष्य",
    savingsGoalInfo:
      "तुमच्या उत्पन्न आणि खर्चाच्या आधारावर एक वास्तववादी मासिक बचत लक्ष्य निर्धारित करा.",
    cancel: "रद्द करा",
    saveGoal: "लक्ष्य जतन करा",
    ...
    amount: "रक्कम (₹)",
    date: "तारीख",
    paymentMethod: "देय पद्धत",
    description: "वर्णन",
    descriptionPlaceholder: "पर्यायी वर्णन...",
    addExpenseSubmit: "खर्च जोडा",

    // Expense List
    noExpensesYet: "अजून कोणताही खर्च ट्रॅक केला नाही",
    noExpensesSubtitle:
      "तुमचे वित्त चांगले व्यवस्थापित करण्यासाठी दैनिक खर्च ट्रॅक करण्यास सुरुवात करा",
    addFirstExpense: "तुमचा पहिला खर्च जोडा",
    loadSampleData: "नमुना डेटा लोड करा",
    noDescription: "वर्णन नाही",
    deleteExpenseConfirm: "हा खर्च हटवायचा?",
    ...
    // Landing Hero
    heroTag: "भारतातील ५ कोटी+ गिग वर्कर्ससाठी बनवलेले",
    heroHeadline1: "क्रेडिट इतिहास नाही?",
    heroHeadline2: "काही हरकत नाही.",
    heroSubtitle1: "पारंपारिक बँका तुम्हाला नाकारतात. आम्ही तुम्हाला समजतो.",
    heroSubtitle2:
      "बँक स्टेटमेंट अपलोड करा → तत्काळ क्रेडिट स्कोर मिळवा → ₹२ लाखांपर्यंत कर्ज मिळवा",
    heroCta1: "तुमचा क्रेडिट स्कोर विनामूल्य मिळवा",
    heroCta2: "हे कसे कार्य करते ते पहा",
    heroTrustLine:
      "✓ क्रेडिट कार्डची गरज नाही  •  ✓ ५ मिनिटांपेक्षा कमी  •  ✓ १००% सुरक्षित",

    // Stats
    stat1Label: "क्रेडिटशिवाय गिग वर्कर्स",
    stat1Sub: "एकट्या भारतात",
    stat2Label: "उपलब्ध क्रेडिट लाइन",
    stat2Sub: "तुमच्या स्कोरवर आधारित",
    stat3Label: "तत्काळ मूल्यांकन",
    ...
    step2Desc: "सुरक्षितपणे तुमचे बँक स्टेटमेंट PDF अपलोड करा",
    step3Title: "तुमचा स्कोर मिळवा",
    step3Desc: "AI त्वरित तुमच्या आर्थिक नमुन्यांचे विश्लेषण करते",
    step4Title: "पात्रता तपासा",
    step4Desc: "तुमची पूर्व-मंजूर कर्ज रक्कम पहा",

    // Trust Section
    trustTitle: "गिग वर्कर्स आमच्यावर का विश्वास ठेवतात",
    trustSubtitle: "गोपनीयता, निष्पक्षता आणि समावेशासह बनवलेले",
    trust1Title: "गिग वर्कर्ससाठी बनवलेले",
    trust1Desc:
      "पारंपारिक बँकांच्या उलट, आम्ही डिलिव्हरी, राइड-हेलिंग आणि फ्रीलांस कामातील अनियमित उत्पन्न नमुने समजतो.",
    trust2Title: "गोपनीयता-प्रथम विश्लेषण",
    trust2Desc:
      "तुमचा डेटा एन्क्रिप्टेड आणि स्थानिक पातळीवर विश्लेषित केला जातो. आम्ही तुमची माहिती कधीही शेअर करत नाही.",
    trust3Title: "क्रेडिट इतिहास आवश्यक नाही",
    trust3Desc:
      "आम्ही आर्थिक व्यवहार नमुन्यांचे मूल्यांकन करतो, CIBIL स्कोर किंवा पारंपारिक क्रेडिट इतिहासाचे नाही.",
    disclaimerLabel: "आम्ही कसे विश्लेषण करतो:",
    disclaimerText:
      "आमचे क्रेडिट मूल्यांकन उत्पन्न सातत्य, खर्च व्यवस्थापन आणि व्यवहार वारंवारता यांसारख्या आर्थिक व्यवहार नमुन्यांवर आधारित आहे.",

    // Roadmap
    roadmapTitle: "भविष्यातील रोडमॅप: थेट प्लॅटफॉर्म एकत्रीकरण",
    roadmapDesc:
      "आम्ही Zomato, Swiggy, Uber, Ola सारख्या आघाडीच्या गिग प्लॅटफॉर्मशी थेट एकत्रीकरण करण्याची योजना आखत आहोत. यामुळे:",
    roadmapBullet1: "तुमच्या संमतीने कमाईच्या डेटावर सुरक्षित प्रवेश",
    roadmapBullet2: "तुमच्या गिग अ‍ॅक्टिव्हिटीवर आधारित रिअल-टाइम क्रेडिट स्कोर अपडेट",
    roadmapBullet3: "मॅन्युअल अपलोडशिवाय स्वयंचलित क्रेडिट मॉनिटरिंग",
    roadmapNote:
      "टीप: हे भविष्यातील आवृत्तीसाठी नियोजित वैशिष्ट्य आहे. सध्या, क्रेडिट स्कोरिंग केवळ बँक स्टेटमेंट अपलोडवर आधारित आहे.",

    // Features
    featuresTitle: "CreditFlow का निवडावे?",
    featuresSubtitle:
      "कर्ज मिळवण्यासाठी आवश्यक सर्व काही, गिग वर्कर्ससाठी डिझाइन केलेले",
    feature1Title: "तत्काळ मंजुरी",
    feature1Desc:
      "५ मिनिटांपेक्षा कमी वेळात तुमचा क्रेडिट स्कोर आणि पात्रता निकाल मिळवा. कोणतीही प्रतीक्षा नाही.",
    feature2Title: "बँक-ग्रेड सुरक्षा",
    feature2Desc:
      "तुमचा आर्थिक डेटा एंड-टू-एंड एन्क्रिप्टेड आहे. आम्ही उद्योग-मानक सुरक्षा प्रोटोकॉल वापरतो.",
    feature3Title: "तुमचा स्कोर सुधारा",
    feature3Desc:
      "वेळेनुसार तुमचे आर्थिक आरोग्य ट्रॅक करा आणि तुमचा स्कोर सुधारण्यासाठी सुचवलेल्या कृती करा.",

    // Final CTA
    ctaTitle1: "हजारो गिग वर्कर्समध्ये सामील व्हा",
    ctaTitle2: "जे त्यांचे क्रेडिट भविष्य घडवत आहेत",
    ctaSubtitle1: "पारंपारिक क्रेडिट सिस्टम तुमच्यासाठी बनलेली नव्हती. आम्ही आहोत.",
    ctaSubtitle2:
      "तुम्ही ड्राइव्ह करा, डिलिव्हरी करा किंवा फ्रीलांस करा — तुमचे उत्पन्न महत्त्वाचे आहे. तुमचे काम महत्त्वाचे आहे.",
    ctaBtn1: "विनामूल्य सुरुवात करा",
    ctaBtn2: "साइन इन करा",
    ctaTrust1: "१००% विनामूल्य मूल्यांकन",
    ctaTrust2: "कोणतेही छुपे शुल्क नाही",
    ctaTrust3: "सुरक्षित आणि खाजगी",

    // Footer
    footerCopy:
      "© 2026 CreditFlow. गिग वर्कर्सना आर्थिक प्रवेशासह सक्षम बनवत आहोत.",
    footerDemo: "शैक्षणिक उद्देशांसाठी नमुना प्रकल्प.",

    // Login Page
    loginWelcomeTitle: "परत स्वागत आहे",
    loginWelcomeSubtitle: "तुमचा डॅशबोर्ड पाहण्यासाठी लॉगिन करा",
    ...
    loginSignUpLink: "मोफत नोंदणी करा",
    loginBackHome: "होमपेजवर परत जा",
    ...
    registerEmploymentFreelancer: "फ्रीलांसर",
    registerPasswordLabel: "पासवर्ड",
    registerConfirmPasswordLabel: "पासवर्डची पुष्टी करा",
    ...
    registerBackHome: "होमपेजवर परत जा",

    // Tax Summary Page
    taxPageTitle: "वार्षिक आर्थिक आणि कर सारांश",
    taxPageSubtitle: "नवीन कर प्रणालीनुसार आर्थिक वर्षासाठी अधिकृत प्रक्षेपण",
    taxDownloadPdf: "PDF डाउनलोड करा",
    taxDownloadPdfPreparing: "तयार होत आहे...",
    taxRetry: "पुन्हा प्रयत्न करा",
    taxDashboard: "डॅशबोर्ड",
    taxLabelGrossIncome: "सकल उत्पन्न",
    taxLabelDeductible: "वजावट योग्य खर्च",
    taxLabelNetTaxable: "निव्वळ करपात्र उत्पन्न",
    taxLabelEstimatedTax: "अंदाजित कर",
    taxLabelEffectiveRate: "प्रभावी कर दर",
    taxSlabTitle: "कर स्लैब तपशील",
    taxSlabSubtitle: "सरकारी निकषांनुसार तपशीलवार कर गणना",
    taxAssessmentYear: "निर्धारण वर्ष",
    taxColSlabRange: "स्लैब श्रेणी",
    taxColTaxableAmount: "करपात्र रक्कम",
    taxColTaxRate: "कर दर",
    taxColTaxAmount: "कर रक्कम",
    taxFinancialOverview: "आर्थिक विहंगावलोकन",
    taxFinancialOverviewSubtitle: "तुमच्या सिंक केलेल्या आर्थिक माहितीमधील मुख्य आकडे",
    taxTotalIncome: "एकूण ट्रॅक केलेले उत्पन्न",
    taxTotalExpenses: "एकूण नोंदवलेले खर्च",
    taxSavingsRate: "बचत दर",
    taxDataRefreshed: "डेटा अपडेट केल्याची तारीख",
    taxNotAvailable: "उपलब्ध नाही",
    taxAdvisory: "सल्ला",
    taxAdvisoryText:
      "हा अहवाल तुमच्या CreditFlow प्रोफाइलमधील सत्यापित उत्पन्न आणि खचर् डॅटावरून तयार केला आहे. कृपया फाइलिंग पुष्टीकरणासाठी प्रमाणित कर तज्ज्ञाचा सल्ला घ्या.",
    taxGeneratedFor: "यांच्यासाठी तयार केले",
    taxNoData: "सध्यातरी कोणताही कर सारांश डेटा उपलब्ध नाही.",
    taxBackToDashboard: "डॅशबोर्डवर परत जा",
    taxPreparingMsg: "कर सारांश तयार होत आहे...",

    // Expense Tracker
    expenseTrackerTitle: "खर्च ट्रॅकर",
    expenseTrackerSubtitle: "तुमच्या खर्चाचा दृश्य तपशील",
    expenseTrackerExecutiveSummary: "स्मार्ट खर्च सारांश",
    expenseTrackerTotal: "एकूण खर्च",
    expenseTrackerAvgDaily: "सरासरी दैनिक खर्च",
    expenseTrackerTopCategory: "मुख्य श्रेणी",
    expenseTrackerEmpty: "या कालावधीसाठी कोणताही खर्च नोंदवलेला नाही.",
    expenseTrackerFilterLabel: "महिन्यानुसार फिल्टर करा",
    expenseTrackerFilterAll: "सर्व",
    expenseTrackerInsightsTitle: "एआय खर्च इनसाइट्स",
    expenseTrackerInsightsSubtitle: "तुमच्या आर्थिक वर्तणुकीवर आधारित",
    expenseTrackerFetchError: "खर्च लोड करण्यात अपयश.",
    expenseTrackerLoading: "तुमचे खर्च लोड होत आहेत...",
    expenseTrackerUnknownCategory: "सामान्य",
    expenseTrackerNoDate: "तारीख उपलब्ध नाही",
    expenseTrackerNoAmount: "नाही",
    expenseTrackerTotalDetail: "निवडलेल्या कालावधीत एकूण खर्च",
    expenseTrackerAvgDailyDetail: "सरासरी दैनिक खर्च",
    expenseTrackerSavingsTrend: "बचत ट्रेंड",
    expenseTrackerExpenseTrend: "खर्च ट्रेंड",
    expenseTrackerTrendSubtitle: "मासिक दृष्टीकोन",
    expenseTrackerSavingsPrediction: "बचत अंदाज",
    expenseTrackerCategorySplit: "श्रेणी विभाजन",
    expenseTrackerCategorySplitSub: "श्रेणीनुसार खर्चाचा तपशील",
    expenseTrackerCategoryComparison: "श्रेणी तुलना",
    expenseTrackerCategoryComparisonSub: "महिन्यागणिक तुलना",
    trackExpensesCta: "तुमचे खर्च ट्रॅक करा",
  },
};
