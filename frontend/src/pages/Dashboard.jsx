  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6">
        ...
        {/* Expenses List */}
        <div
          className={`rounded-lg shadow-md p-5 ${isDark ? "bg-gray-900" : "bg-white"}`}
        >
          {expenses.length === 0 ? (
                ...
                >
                  <div className="flex-1">
                    <div className="flex items-center space-x-3">
                      <div
                        className={`w-10 h-10 rounded-full flex items-center justify-center ${isDark ? "bg-blue-900/40" : "bg-blue-100"}`}
                      >
                        <svg
                          className={`w-5 h-5 ${isDark ? "text-blue-400" : "text-blue-900"}`}
                          fill="currentColor"
